...
add_fileset_file snake_consts.svh OTHER PATH ../../snake_game/verilog/snake_consts.svh
add_fileset_file snake_fpga.sv SYSTEM_VERILOG PATH ../../snake_game/verilog/snake_fpga.sv TOP_LEVEL_FILE
add_fileset_file scores.sv SYSTEM_VERILOG PATH ../../snake_game/verilog/scores.sv
...
# 
# connection point reset_conduit
# 
add_interface reset_conduit conduit end
set_interface_property reset_conduit associatedClock clock
set_interface_property reset_conduit associatedReset reset
set_interface_property reset_conduit ENABLED true
set_interface_property reset_conduit EXPORT_OF ""
set_interface_property reset_conduit PORT_NAME_MAP ""
set_interface_property reset_conduit CMSIS_SVD_VARIABLES ""
set_interface_property reset_conduit SVD_ADDRESS_GROUP ""

add_interface_port reset_conduit dbg_rst_n reset_n Input 1


# 
# connection point state_export_conduit
# 
add_interface state_export_conduit conduit end
set_interface_property state_export_conduit associatedClock clock
set_interface_property state_export_conduit associatedReset reset
set_interface_property state_export_conduit ENABLED true
set_interface_property state_export_conduit EXPORT_OF ""
set_interface_property state_export_conduit PORT_NAME_MAP ""
set_interface_property state_export_conduit CMSIS_SVD_VARIABLES ""
set_interface_property state_export_conduit SVD_ADDRESS_GROUP ""

add_interface_port state_export_conduit state_export readdata Output 7


# 
# connection point cmd_conduit
# 
add_interface cmd_conduit conduit end
set_interface_property cmd_conduit associatedClock clock
set_interface_property cmd_conduit associatedReset reset
set_interface_property cmd_conduit ENABLED true
set_interface_property cmd_conduit EXPORT_OF ""
set_interface_property cmd_conduit PORT_NAME_MAP ""
set_interface_property cmd_conduit CMSIS_SVD_VARIABLES ""
set_interface_property cmd_conduit SVD_ADDRESS_GROUP ""

add_interface_port cmd_conduit cmd_export readdata Output 7
