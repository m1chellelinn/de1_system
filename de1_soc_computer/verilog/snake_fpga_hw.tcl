...
# 
# connection point colour_master
# 
add_interface colour_master avalon start
set_interface_property colour_master addressUnits SYMBOLS
set_interface_property colour_master associatedClock clock
set_interface_property colour_master associatedReset reset
set_interface_property colour_master bitsPerSymbol 8
set_interface_property colour_master burstOnBurstBoundariesOnly false
set_interface_property colour_master burstcountUnits WORDS
set_interface_property colour_master doStreamReads false
set_interface_property colour_master doStreamWrites false
set_interface_property colour_master holdTime 0
set_interface_property colour_master linewrapBursts false
set_interface_property colour_master maximumPendingReadTransactions 0
set_interface_property colour_master maximumPendingWriteTransactions 0
set_interface_property colour_master readLatency 0
set_interface_property colour_master readWaitTime 1
set_interface_property colour_master setupTime 0
set_interface_property colour_master timingUnits Cycles
set_interface_property colour_master writeWaitTime 0
set_interface_property colour_master ENABLED true
set_interface_property colour_master EXPORT_OF ""
set_interface_property colour_master PORT_NAME_MAP ""
set_interface_property colour_master CMSIS_SVD_VARIABLES ""
set_interface_property colour_master SVD_ADDRESS_GROUP ""

add_interface_port colour_master vga_ch_address address Output 32
add_interface_port colour_master vga_ch_read read Output 1
add_interface_port colour_master vga_ch_waitrequest waitrequest Input 1
add_interface_port colour_master vga_ch_readdata readdata Input 16
add_interface_port colour_master vga_ch_write write Output 1
add_interface_port colour_master vga_ch_writedata writedata Output 16
